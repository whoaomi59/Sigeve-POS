    ...
    (newProps) => {
        if (form.custom_discount.discount_type === "fixed") {
            ...
            form.total = numberFormat(
                newProps.total -
                    newProps.cartSubtotal *
                        (form.custom_discount.discount / 100)
            );
            form.paid = numberFormat(
                newProps.total -
                    newProps.cartSubtotal *
                        (form.custom_discount.discount / 100)
            );
...
watch(
    ...
    async (newForm, oldForm) => {
        if (form.custom_discount.discount_type === "fixed") {
            ...
            form.total = numberFormat(
                props.total -
                    props.cartSubtotal * (form.custom_discount.discount / 100)
            );
            form.paid = numberFormat(
                props.total -
                    props.cartSubtotal * (form.custom_discount.discount / 100)
    ...
    <AuthenticatedLayout>
        ...
        <div class="flex flex-wrap">
            <div class="w-full px-4">
                <div
                    class="relative -mt-16 flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded bg-white"
                >
                    <div class="flex lg:flex-row flex-col-reverse shadow-lg">
                        <!-- left section -->
                        <div
                            class="lg:w-4/5 min-h-screen shadow-lg overflow-auto max-h-screen"
                        >
                            <!-- header -->
                            <div
                                class="flex flex-row justify-between items-center px-5 mt-5"
                            >
                            ...
                            <!-- products -->
                            <div
                                class="grid grid-cols-3 gap-4 px-5 mt-5 overflow-y-auto h-4/6"
                            >
                                <div
                                ...
                                >
                                    <div
                                        class="flex justify-center items-center md:p-3"
                                    >
                                        <img
                                            :src="product.photo"
                        ...
                        <div class="lg:w-2/5">
                            <!-- header -->
                            <div
                                class="flex flex-row items-center justify-between px-5 mt-5"
                            >
                            ...
                            <div class="px-5 mt-1">
                                <div class="pt-2 rounded-md shadow-lg">
                                    ...
                                    >
                                        <div
                                            class="text-sm flex items-center flex-wrap"
                                        >
                                            <span
                                    ...
                                    <div>
                                        ...
                                        <div class="flex mt-1">
                                            ...
                                            >
                                                <option
                                                    v-for="(
                                                        orderPaidByType, index
                                                    ) in orderPaidByTypes"
                                                    :key="index"
                                                    :value="
                                                        orderPaidByType.value
                                                    "
                                                >
                            ...
                            <div class="px-5 mt-3 mb-4">
                                <SubmitButton
                                    ...
                                    :class="
                                        !carts.total ? 'cursor-not-allowed' : ''
                                    "
